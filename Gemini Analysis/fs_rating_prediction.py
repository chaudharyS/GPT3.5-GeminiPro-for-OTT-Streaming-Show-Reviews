...
def analyze_gemini(text):
    try:
        ...
        system_message = """You are trained to analyze and predict the rating from the review text.
...
df['Predicted_Rating_fs_gemini'] = df['Review'].progress_apply(analyze_gemini)

output_file = '../Rating-Prediction/audience_reviews_test_fs_gemini.csv'
